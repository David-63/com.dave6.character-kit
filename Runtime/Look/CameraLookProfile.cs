...
namespace Dave6.CharacterKit.Look
{
    [CreateAssetMenu(fileName = "CameraLookProfile", menuName = "DaveAssets/Profile/CameraLookProfile")]
    public class CameraLookProfile : ScriptableObject
    {
