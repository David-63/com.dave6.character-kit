...
namespace Dave6.CharacterKit.Item
{
    ...
    public class Inventory
    {
        ...
        public event Action<EEquipSlotType, EquippedItem> onItemEquipped;
        public event Action<EEquipSlotType, EquippedItem> onItemUnEquipped;
        ...
        internal bool AttachToSlot(EEquipSlotType slot, OwnedItem item)
        {
            ...
            onItemEquipped?.Invoke(slot, m_EquippedItems[slot]);
        ...
        internal bool DetachFromSlot(EEquipSlotType slot)
        {
            ...
            {
                onItemUnEquipped?.Invoke(slot, prev);
