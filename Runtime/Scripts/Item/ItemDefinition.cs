...
namespace Dave6.CharacterKit.Item
{
    ...
    {
        public StatTag tag;
        public EStatValueType valueType;
    ...
    {
        public StatTag tag;
        public EValueOperationType operationType;
        public float magnitude;
    }
    ...
    public class ItemDefinition : ScriptableObject
    {
        ...
        public EStatAffectMode affectMode;
        public StatValueOption[] statValueOptions;
        public ValueOperationOption[] valueOperationOptions;    // 이건 소모탬
