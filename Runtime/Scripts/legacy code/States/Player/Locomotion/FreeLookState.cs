...
// {
//     public class FreeLookState : BaseState<PlayerCharacter>
//     {
//         StatHandler m_StatHandler;
//         BaseStat m_MoveStat;

//         public FreeLookState(PlayerCharacter controller, BaseStat moveStat) : base(controller)
//         {
...
//         {
//             controller.animatorHandler.UpdateMoveInput(controller.horizontalSpeed, hasInput);
//             controller.animatorHandler.EvaluateMoveInputTransition(controller.horizontalSpeed, hasInput);
//         }
...
//             if (controller.combatHandler.attacking)
//             {
